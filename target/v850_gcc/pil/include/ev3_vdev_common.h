 ...
 * IMU
*/
#define SPIKE_SENSOR_IMU_OFF				(272U)
#define SPIKE_SENSOR_IMU_OFF_TYPE(index)	(SPIKE_SENSOR_IMU_OFF + ((index) * 4U))
#define SPIKE_SENSOR_IMU_INX_ACCELARATION_X		(0U)
#define SPIKE_SENSOR_IMU_INX_ACCELARATION_Y		(1U)
#define SPIKE_SENSOR_IMU_INX_ACCELARATION_Z		(2U)
#define SPIKE_SENSOR_IMU_INX_VELOCITY_X			(3U)
#define SPIKE_SENSOR_IMU_INX_VELOCITY_Y			(4U)
#define SPIKE_SENSOR_IMU_INX_VELOCITY_Z			(5U)

/*
 * HSV
 */
#define SPIKE_SENSOR_HSV_OFF				(296U)
#define SPIKE_SENSOR_HSV_OFF_TYPE(index)	(SPIKE_SENSOR_HSV_OFF + ((index) * 4U))
#define SPIKE_SENSOR_HSV_INX_H		(0U)
#define SPIKE_SENSOR_HSV_INX_S		(1U)
#define SPIKE_SENSOR_HSV_INX_V		(2U)
