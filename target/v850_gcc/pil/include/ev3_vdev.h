 ...
 * 4bytes data
 */
#define SPIKE_SENSOR_IMU_ADDR_INX(index)	(VDEV_TX_DATA_BASE + SPIKE_SENSOR_IMU_OFF_TYPE(index))
#define SPIKE_SENSOR_IMU_ADDR_ACCELARATION_X		SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_ACCELARATION_X)
#define SPIKE_SENSOR_IMU_ADDR_ACCELARATION_Y		SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_ACCELARATION_Y)
#define SPIKE_SENSOR_IMU_ADDR_ACCELARATION_Z		SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_ACCELARATION_Z)
#define SPIKE_SENSOR_IMU_ADDR_VELOCITY_X			SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_VELOCITY_X)
#define SPIKE_SENSOR_IMU_ADDR_VELOCITY_Y			SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_VELOCITY_Y)
#define SPIKE_SENSOR_IMU_ADDR_VELOCITY_Z			SPIKE_SENSOR_IMU_ADDR_INX(SPIKE_SENSOR_IMU_INX_VELOCITY_Z)

/*
 * HSV(TX)
 * 4bytes data
 */
#define SPIKE_SENSOR_HSV_ADDR_INX(index)	(VDEV_TX_DATA_BASE + SPIKE_SENSOR_HSV_OFF_TYPE(index))
#define SPIKE_SENSOR_HSV_ADDR_H		SPIKE_SENSOR_HSV_ADDR_INX(SPIKE_SENSOR_HSV_INX_H)
#define SPIKE_SENSOR_HSV_ADDR_S		SPIKE_SENSOR_HSV_ADDR_INX(SPIKE_SENSOR_HSV_INX_S)
#define SPIKE_SENSOR_HSV_ADDR_V		SPIKE_SENSOR_HSV_ADDR_INX(SPIKE_SENSOR_HSV_INX_V)
