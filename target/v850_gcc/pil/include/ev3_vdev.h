 ...
 * 4bytes data
 */
#define SPIKE_SENSOR_IMU_ADDR_INX(index)	(VDEV_RX_DATA_BASE + SPIKE_SENSOR_IMU_OFF_TYPE(index))
 ...
 * 4bytes data
 */
#define SPIKE_SENSOR_HSV_ADDR_INX(index)	(VDEV_RX_DATA_BASE + SPIKE_SENSOR_HSV_OFF_TYPE(index))
